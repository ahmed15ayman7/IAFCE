// Parallel Route: الإشعارات غير المقروءة
'use client';
...
export default function UnreadNotificationsTab() {
  const { user } = useUser();
  ...
  return (
    <div className="space-y-4">
      {unread.length === 0 ? (
        <div className="text-center text-gray-400">لا توجد إشعارات غير مقروءة</div>
      ) : (
